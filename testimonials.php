...
<!-- Mirrored from dreamingtheme.kiendaotac.com/html/akasha/testimonials.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 04 Apr 2024 12:43:51 GMT -->
    ...
    <main class="site-main main-container no-sidebar">
        <div>
            ...
            <div class="section-018">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12 offset-xl-6 col-xl-6 offset-lg-6 col-lg-6">
                            <div class="akasha-slide">
                                <div class="owl-slick equal-container better-height dots-light"
                                    ...
                                    <div class="akasha-testimonial style-01">
        ...
        <div class="section-043">
            <div class="container">
                <div class="akasha-heading style-01">
                    <div class="heading-inner">
                        <h3 class="title">
                            Testimonial Horizontal Slide </h3>
                        <div class="subtitle">
                            Lorem ipsum dolor sit amet consectetur adipiscing elit erat vehicula ad, mollis viverra
                            vulputate
                        </div>
