...
<!-- Mirrored from dreamingtheme.kiendaotac.com/html/akasha/single-product-group.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 04 Apr 2024 12:43:46 GMT -->
<head>
    <meta charset="UTF-8"/>
    ...
    <div class="container">
        <div class="row">
            <div class="main-content col-md-12">
                ...
                <div id="product-27"
                     class="product-type-grouped post-27 product type-product status-publish has-post-thumbnail product_cat-table product_cat-new-arrivals product_cat-lamp product_tag-table product_tag-sock first instock shipping-taxable purchasable product-type-variable has-default-attributes">
                    <div class="main-contain-summary">
                        <div class="contain-left has-gallery">
                            ...
                            <div class="summary entry-summary">
                                ...
                                <form class="cart grouped_form" action="#" method="post" >
                                    <table class="akasha-grouped-product-list group_table" cellspacing="0">
                                        <tbody>
                                        <tr id="product-20" class="akasha-grouped-product-list-item post-20 product type-product status-publish has-post-thumbnail product_cat-light product_cat-new-arrivals product_cat-specials product_tag-table product_tag-hat product_tag-sock instock sale featured shipping-taxable purchasable product-type-simple"><td class="akasha-grouped-product-list-item__quantity">    <div class="quantity">
                                        ...
                                        </td><td class="akasha-grouped-product-list-item__label"><label for="product-20"><a href="#">Mini Dress</a></label></td><td class="akasha-grouped-product-list-item__price"><del><span class="akasha-Price-amount amount"><span class="akasha-Price-currencySymbol">$</span>150.00</span></del> <ins><span class="akasha-Price-amount amount"><span class="akasha-Price-currencySymbol">$</span>139.00</span></ins></td></tr><tr id="product-28" class="akasha-grouped-product-list-item post-28 product type-product status-publish has-post-thumbnail product_cat-light product_cat-chair product_cat-sofas product_tag-light product_tag-sock last instock sale featured shipping-taxable purchasable product-type-simple"><td class="akasha-grouped-product-list-item__quantity">    <div class="quantity">
                                            <span class="qty-label">Quantiy:</span>
                                            <div class="control">
                                                <a class="btn-number qtyminus quantity-minus" href="#">-</a>
                                                <input type="text" data-step="1" min="0" max="" name="quantity[25]" value="0" title="Qty" class="input-qty input-text qty text" size="4" pattern="[0-9]*" inputmode="numeric">
                                        ...
                                        </td><td class="akasha-grouped-product-list-item__label"><label for="product-28"><a href="#">Classic Shirt</a></label></td><td class="akasha-grouped-product-list-item__price"><del><span class="akasha-Price-amount amount"><span class="akasha-Price-currencySymbol">$</span>138.00</span></del> <ins><span class="akasha-Price-amount amount"><span class="akasha-Price-currencySymbol">$</span>119.00</span></ins></td></tr><tr id="product-32" class="akasha-grouped-product-list-item post-32 product type-product status-publish has-post-thumbnail product_cat-light product_cat-chair product_cat-sofas product_tag-hat product_tag-sock first instock sale featured shipping-taxable purchasable product-type-simple"><td class="akasha-grouped-product-list-item__quantity">    <div class="quantity">
                                            <span class="qty-label">Quantiy:</span>
                                            <div class="control">
                                                <a class="btn-number qtyminus quantity-minus" href="#">-</a>
                                                <input type="text" data-step="1" min="0" max="" name="quantity[25]" value="0" title="Qty" class="input-qty input-text qty text" size="4" pattern="[0-9]*" inputmode="numeric">
                                        ...
                                        </td><td class="akasha-grouped-product-list-item__label"><label for="product-32"><a href="#">Women Bags</a></label></td><td class="akasha-grouped-product-list-item__price"><del><span class="akasha-Price-amount amount"><span class="akasha-Price-currencySymbol">$</span>109.00</span></del> <ins><span class="akasha-Price-amount amount"><span class="akasha-Price-currencySymbol">$</span>89.00</span></ins></td></tr>		</tbody>
                                    </table>
                        ...
                        <div class="product-inner tooltip-left">
                            ...
                            <div class="product-info equal-elem">
                                ...
                                <span class="price"><del><span class="akasha-Price-amount amount"><span
                                        class="akasha-Price-currencySymbol">$</span>89.00</span></del> <ins><span
                                        class="akasha-Price-amount amount"><span
            ...
            <div class="col-md-12 col-sm-12 akasha_dreaming_upsell-product">
                ...
                <div class="owl-slick owl-products equal-container better-height"
                    ...
                    <div class="product-item style-01 post-37 product type-product status-publish has-post-thumbnail product_cat-chair product_cat-bed product_tag-light product_tag-hat product_tag-sock first instock shipping-taxable purchasable product-type-simple  ">
                        <div class="product-inner tooltip-left">
                            <div class="product-thumb">
                                <a class="thumb-link akasha-product-gallery__image"
                                   href="#"
                                   tabindex="0">
