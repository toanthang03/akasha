...
<!-- Mirrored from dreamingtheme.kiendaotac.com/html/akasha/instagram-feed.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 04 Apr 2024 12:43:51 GMT -->
<head>
    <meta charset="UTF-8"/>
    ...
    <div class="banner-wrapper-inner">
        ...
        <div role="navigation" aria-label="Breadcrumbs" class="breadcrumb-trail breadcrumbs">
            <ul class="trail-items breadcrumb">
                ...
                <li class="trail-item trail-end active"><span>Instagram Feed</span>
                </li>
            </ul>
        </div>
    </div>
...
<main class="site-main main-container no-sidebar">
    ...
    <div class="section-043">
        <div class="container">
            ...
            <div class="row akasha-instagram style-01 instagram-grid">
                ...
                <div class="col-md-6 col-lg-4 col-xl-3">
                    <a target="_blank" href="#" class="item" tabindex="0">
                        <img class="img-responsive lazy" src="assets/images/insta9.jpg" alt="Home 01">
                        <span class="instagram-info">
                             <span class="social-wrap">
                                <span class="social-info">1
                                    <i class="flaticon-chat"></i>
                ...
                <div class="col-md-6 col-lg-4 col-xl-3">
                    <a target="_blank" href="#" class="item" tabindex="0">
                        <img class="img-responsive lazy" src="assets/images/insta10.jpg" alt="Home 01">
                        <span class="instagram-info">
                             <span class="social-wrap">
                                <span class="social-info">1
                                    <i class="flaticon-chat"></i>
                ...
                <div class="col-md-6 col-lg-4 col-xl-3">
                    <a target="_blank" href="#" class="item" tabindex="0">
                        <img class="img-responsive lazy" src="assets/images/insta11.jpg" alt="Home 01">
                        <span class="instagram-info">
                             <span class="social-wrap">
                                <span class="social-info">1
                                    <i class="flaticon-chat"></i>
                ...
                <div class="col-md-6 col-lg-4 col-xl-3">
                    <a target="_blank" href="#" class="item" tabindex="0">
                        <img class="img-responsive lazy" src="assets/images/insta12.jpg" alt="Home 01">
                        <span class="instagram-info">
                             <span class="social-wrap">
                                <span class="social-info">1
                                    <i class="flaticon-chat"></i>
